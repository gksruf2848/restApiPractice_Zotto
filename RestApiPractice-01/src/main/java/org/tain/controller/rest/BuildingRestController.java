...
import org.tain.mybatis.mappers.BuildingMapper;
...
public class BuildingRestController {
	...
	@RequestMapping(value = {"/buildings"}, method = {RequestMethod.GET, RequestMethod.POST})
	public ResponseEntity<?> test(HttpEntity<String> httpEntity) throws Exception {
		...
		if (Boolean.TRUE) {
			...
			lst = this.buildingMapper.selectAll(mapIn);
			log.info(">>>>> lst: {}", lst);
		}
